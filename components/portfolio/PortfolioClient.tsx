          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <AnimatePresence mode="popLayout">
              {filtered.map((project) => (
                ...
                >
                  <div className="h-44 sm:h-56 flex items-center justify-center text-5xl sm:text-6xl relative overflow-hidden" style={{ background: project.gradient }}>
                  ...
                  <div className="p-4 sm:p-6">
                    ...
                    <div className="flex items-center justify-between gap-3">
                      <span className="text-xs text-[#475569] truncate">{project.client}</span>
                      <span className="text-xs text-[#6366F1] font-medium whitespace-nowrap">View Details {`->`}</span>
                    </div>
                  </div>
                </motion.article>
              ))}
